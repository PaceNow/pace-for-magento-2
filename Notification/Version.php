...
class Version implements \Magento\Framework\Notification\MessageInterface
{
    ...
    {
        // message text
        $html = sprintf("There is a new version of <strong>Pace For Magento 2</strong> available. Click %s.", '<a href="https://developers.pacenow.co/#plugins-magento2" target="_blank">here</a> to view.');
        return $html;
    }
